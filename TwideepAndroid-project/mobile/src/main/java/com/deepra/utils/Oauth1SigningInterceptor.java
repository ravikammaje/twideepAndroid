...
public final class Oauth1SigningInterceptor implements Interceptor {
    ...
    public String returnOauthSignature(Request request) throws IOException {
        byte[] nonce = new byte[32];
        random.nextBytes(nonce);
        String oauthNonce = ByteString.of(nonce).base64().replaceAll("\\W", "");
        String oauthTimestamp = String.valueOf(java.lang.System.currentTimeMillis()/1000);
...
//                .build();
    ...
    public Request signRequest(Request request) throws IOException {
        ...
        random.nextBytes(nonce);
        String oauthNonce = ByteString.of(nonce).base64().replaceAll("\\W", "");
        String oauthTimestamp = String.valueOf(java.lang.System.currentTimeMillis());
